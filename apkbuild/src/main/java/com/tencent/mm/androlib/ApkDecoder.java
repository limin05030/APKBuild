...
public class ApkDecoder {
    ...
    private void ensureFilePath() throws IOException {
        ...
        if (config.mLogEnabled) {
            System.out.println(String.format("unziping apk to %s\n", unZipDest));
        }
    ...
    public void decode() throws AndrolibException, IOException, DirectoryException {
        if (hasResources()) {
            ...
            if (config.mLogEnabled) {
                System.out.println("decoding resources.arsc\n");
            }
            RawARSCDecoder.decode(mApkFile.getDirectory().getFileInput("resources.arsc"), config.mLogEnabled);
            ResPackage[] pkgs = ARSCDecoder.decode(mApkFile.getDirectory().getFileInput("resources.arsc"), this, config.mLogEnabled);
