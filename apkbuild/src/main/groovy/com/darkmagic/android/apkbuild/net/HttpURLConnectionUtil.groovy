package com.darkmagic.android.apkbuild.net
...
class HttpURLConnectionUtil {
    static final String HTTPMETHOD_GET = "GET"
    static final String HTTPMETHOD_POST = "POST"
    static final String HTTPMETHOD_PUT = "PUT"
